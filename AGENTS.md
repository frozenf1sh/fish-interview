...
11. Trace renderer changes must keep `/static/app.js` and `/static/app.css` content-fingerprinted in rendered pages. A cached older player must never receive a newer trace schema.
